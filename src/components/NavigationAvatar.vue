<template>
  <v-card
    class="border ma-4 pa-2 rounded-lg pl-4 pr-4 d-flex align-center ga-2"
    elevation="0"
  >
    <svg
      width="32px"
    ...
    <div class="navigation-avatar__title mt-1">
      <p class="text-subtitle-1">
        {{ $t('hello') }}, <strong>{{ $t('guest') }}</strong>
      </p>
      <p class="text-grey-lighten-1 text-subtitle-2">
        Online
      </p>
    </div>
  </v-card>
...
@Component
export class NavigationAvatar extends Vue {
}
let component = NavigationAvatar;
